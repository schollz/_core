...
goto the [latest release](https://github.com/schollz/_core/releases/latest) and download `core_windows_v2.0.5.exe`.
...
```
curl -L https://github.com/schollz/_core/releases/download/v2.0.5/core_macos_amd64_v2.0.5 > core_macos
```

or, if you are on a M1/M2-based mac install with:

```
curl -L https://github.com/schollz/_core/releases/download/v2.0.5/core_macos_aarch64_v2.0.5 > core_macos
```
...
goto the [latest release](https://github.com/schollz/_core/releases/latest) and download `core_linux_amd64_v2.0.5`. 
