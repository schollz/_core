...
If it happens a lot, please try using [this firmware](https://github.com/schollz/_core/releases/download/v6.3.3/ectocore_no_overclocking_v6.3.3.uf2) which disables overclocking, allows fewer fx, but should increase the stability.
...
1) Internally clock Ectocore using the non-overclocking firmware (found [here](https://github.com/schollz/_core/releases/download/v6.3.3/ectocore_no_overclocking_v6.3.3.uf2)). This is more stable than my external clock source (Pam's new workout).
...
| ---------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Overclocking     | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5.uf2)                 | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5_low_latency.uf2)                 | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5_ultralow_latency.uf2)                 |
| Non-Overclocking | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5_no_overclocking.uf2) | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5_no_overclocking_low_latency.uf2) | [v6.3.5](https://github.com/schollz/_core/releases/download/v6.3.5/ectocore_v6.3.5_no_overclocking_ultralow_latency.uf2) |
