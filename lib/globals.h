...
#define MODE_HOLD_DURATION_THRESHOLD 300
...
// Conceptual Grimoire effect index (0-15), not the DSP FX_* index.
volatile int8_t grimoire_direct_effect = GRIMOIRE_EFFECT_NONE;
volatile uint16_t grimoire_direct_value = 0;
