 ...
 *
 * This library uses the \ref hardware_pio system to implement a I2S audio
 * interface
 *
...
#define PICO_AUDIO_I2S_SILENCE_BUFFER_SAMPLE_LENGTH \
  PICO_AUDIO_SILENCE_BUFFER_SAMPLE_LENGTH
#else
...
#define PICO_AUDIO_I2S_DATA_PIN 13        // 18 SDO -> DIN
 ...
 * \param producer
 *
 *  todo make a common version (or a macro) .. we don't want to pull in
 * unnecessary code by default
 */
