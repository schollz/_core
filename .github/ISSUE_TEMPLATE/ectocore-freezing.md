...
If you are encountering a freeze, you might first try to upload this [new firmware that disables overclocking](https://github.com/schollz/_core/releases/download/v6.2.18/ectocore_no_overclocking_v6.2.18.uf2).
