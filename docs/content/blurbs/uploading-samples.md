...
### Use tool online: **[zeptocore v3.0.2](/tool)** (Chrome and Firefox only)
...
#### Download for Windows: **[x64](https://github.com/schollz/_core/releases/download/v3.0.2/core_windows_v3.0.2.exe)**
...
```
curl -L https://github.com/schollz/_core/releases/download/v3.0.2/core_macos_amd64_v3.0.2 > core_macos
```

Or, if you are on a M1/M2-based mac install with:

```
curl -L https://github.com/schollz/_core/releases/download/v3.0.2/core_macos_aarch64_v3.0.2 > core_macos
```
...
#### Download for Linux: **[x64](https://github.com/schollz/_core/releases/download/v3.0.2/core_linux_amd64_v3.0.2)**
