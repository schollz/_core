...
### Use tool online: **[zeptocore v6.0.0](/tool)** (Chrome and Firefox only)
...
#### Download for Windows: **[x64](https://github.com/schollz/_core/releases/download/v6.0.0/core_windows_v6.0.0.exe)**
...
#### Download for Linux: **[x64](https://github.com/schollz/_core/releases/download/v6.0.0/core_linux_amd64_v6.0.0)**
