...
### Use tool online: **[zeptocore v6.3.3](/tool)** (Chrome and Firefox only)
...
#### Download for Windows: **[x64](https://github.com/schollz/_core/releases/download/v6.3.3/core_windows_v6.3.3.exe)**
...
```
curl -L https://github.com/schollz/_core/releases/download/v6.3.3/core_macos_amd64_v6.3.3 > core_macos
```

Or, if you are on a M1/M2-based mac install with:

```
curl -L https://github.com/schollz/_core/releases/download/v6.3.3/core_macos_aarch64_v6.3.3 > core_macos
```
...
#### Download for Linux: **[x64](https://github.com/schollz/_core/releases/download/v6.3.3/core_linux_amd64_v6.3.3)**
