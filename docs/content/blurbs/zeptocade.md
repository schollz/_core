...
[zeptocade is now entirely open-source](https://infinitedigits.co/zeptocade/), including the BOM, Gerbers, schematic, and source code. while it is no longer sold or built by me, everything is available for you to DIY yourself.
