...
### Latest firmware: **[zeptocore v5.0.10](https://github.com/schollz/_core/releases/download/v5.0.10/zeptocore_v5.0.10.uf2)**
...
4. Drag and drop the downloaded **zeptocore_v5.0.10.uf2** file onto the `RPI-RP2` drive.
...
(_Note:_ If using [zeptoboard](#zeptoboard), follow the same instructions but ensure you download the latest [zeptoboard_v5.0.10.uf2](https://github.com/schollz/_core/releases/download/v5.0.10/zeptoboard_v5.0.10.uf2)).
