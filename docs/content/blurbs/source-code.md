...
### Latest firmware: **[zeptocore v2.2.1](https://github.com/schollz/_core/releases/download/v2.2.1/zeptocore_v2.2.1.uf2)**
...
4. Drag and drop the downloaded **zeptocore_v2.2.1.uf2** file onto the `RPI-RP2` drive.
