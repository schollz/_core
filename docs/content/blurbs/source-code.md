...
### Latest firmware: **[zeptocore v2.3.2](https://github.com/schollz/_core/releases/download/v2.3.2/zeptocore_v2.3.2.uf2)**
...
4. Drag and drop the downloaded **zeptocore_v2.3.2.uf2** file onto the `RPI-RP2` drive.
...
(_Note:_ If using [zeptoboard](#zeptoboard), follow the same instructions but ensure you download the latest [zeptoboard_v2.3.2.uf2](https://github.com/schollz/_core/releases/download/v2.3.2/zeptoboard_v2.3.2.uf2)).
