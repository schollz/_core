...
### Latest firmware: **[zeptocore v6.0.0](https://github.com/schollz/_core/releases/download/v6.0.0/zeptocore_v6.0.0.uf2)**
...
(_Note:_ If using [zeptoboard](#zeptoboard), follow the same instructions but ensure you download the latest [zeptoboard_v6.0.0.uf2](https://github.com/schollz/_core/releases/download/v6.0.0/zeptoboard_v6.0.0.uf2)).
