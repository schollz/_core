...
### Latest firmware: **[zeptocore v6.4.6](https://github.com/schollz/_core/releases/download/v6.4.6/zeptocore_v6.4.6.uf2)**
...
4. Drag and drop the downloaded **zeptocore_v6.4.6.uf2** file onto the `RPI-RP2` drive.
...
(_Note:_ If using [zeptoboard](#zeptoboard), follow the same instructions but ensure you download the latest [zeptoboard_v6.4.6.uf2](https://github.com/schollz/_core/releases/download/v6.4.6/zeptoboard_v6.4.6.uf2)).
