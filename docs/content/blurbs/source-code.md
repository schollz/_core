...
### Latest firmware: **[zeptocore v2.6.0](https://github.com/schollz/_core/releases/download/v2.6.0/zeptocore_v2.6.0.uf2)**
...
4. Drag and drop the downloaded **zeptocore_v2.6.0.uf2** file onto the `RPI-RP2` drive.
...
(_Note:_ If using [zeptoboard](#zeptoboard), follow the same instructions but ensure you download the latest [zeptoboard_v2.6.0.uf2](https://github.com/schollz/_core/releases/download/v2.6.0/zeptoboard_v2.6.0.uf2)).
